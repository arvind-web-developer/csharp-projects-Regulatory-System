                ...
                c => new
                    {
                        ...
                        EndDate = c.String(),
                        AlternateContactFirstName = c.String(),
                        AlternateContactLastName = c.String(),
                        IsCoreTeamMember = c.Boolean(nullable: false),
                        IsActive = c.Boolean(nullable: false),
                        Comment = c.String(),
                        VechileRegoNo = c.String(),
                        VechileMake = c.String(),
                        AveragePerKM = c.String(),
                        IsChowkidar = c.Boolean(nullable: false),
                        IsSupplier = c.Boolean(nullable: false),
                        IsMember = c.Boolean(nullable: false),
                        MemberNo = c.String(),
                        IsResidentialProofChecked = c.Boolean(nullable: false),
